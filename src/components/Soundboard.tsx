...
const Soundboard = ({ loaded, kits, playSound }: Props) => {
  ...
  return (
    <div className="lg:flex hidden items-center h-[45%] max-h-96 bg-gradient-to-br from-romantic-cream to-secondary overflow-auto shadow-inner border-y-2 border-romantic-pink">
      {/* Keyboard Icon */}
      <div className="w-[5%] flex justify-center pl-3">
        <svg className="fill-romantic-rose w-[28px] drop-shadow-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
      ...
      <div className="w-[5%] flex justify-center pr-3">
        <svg className="fill-romantic-rose w-[18px] drop-shadow-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
